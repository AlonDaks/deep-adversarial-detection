...
def train_alex_detect_net():
    ...
    checkpointer = ModelCheckpoint(filepath="/home/ubuntu/storage_volume/alex_detect_net/weights_lr_1000.{epoch:02d}.hdf5", verbose=1)
    model.fit(data['X_train'], data['adversarial_labels_train'], shuffle='batch', batch_size=128*4, nb_epoch=5, callbacks=[checkpointer])
    model.save('/home/ubuntu/storage_volume/alex_detect_net/alex_detect_net_5_epochs_lr_1000.h5')
